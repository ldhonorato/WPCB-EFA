...
# path_model = "./data/WeaponS_DA_2_coco_para_tf/"
path_model = "./data/my_data/"
### Some paths
train_file = path_model+"train.txt"  # The path of the training txt file.
val_file = path_model+"val.txt"  # The path of the validation txt file.
restore_path = "./data/darknet_weights/yolov3.ckpt"  # The path of the weights to restore.
save_dir = path_model+"checkpoint/"  # The directory of the weights to save.
...
anchor_path = path_model+"yolo_anchors.txt"  # The path of the anchor txt file.
class_name_path = path_model+"/data.names"  # The path of the class names.
...
#img_size = [616, 410]  # Images will be resized to `img_size` and fed to the network, size format: [width, height]
