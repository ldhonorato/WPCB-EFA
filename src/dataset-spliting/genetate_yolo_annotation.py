...
#    
    fileoutput = '/home/lhss/Documents/Artigo PDI/database/yolo_annotation.txt'
    file = open(fileoutput,'w+')
    index = 0
    root = '/home/lhss/Documents/Artigo PDI/database'
        ...
        for p in pcb_folders:
            ...
            for rec in rec_ids:
                ...
                for n in annotations:
                    ...
                    line = '{index} {path} {classe} {x_min} {y_min} {x_max} {y_max}\r\n'.format(index=index, 
                            path=rpath, 
                            classe = 0,
                            x_min = min_x,
                            y_min = min_y,
